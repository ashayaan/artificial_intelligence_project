...
if __name__ == '__main__':	
	filename =["../../data_files/HMM-Log-data/genome-properties-alpha.csv","../../data_files/HMM-Log-data/genome-properties-beta.csv","../../data_files/HMM-Log-data/genome-properties-flex.csv","../../data_files/HMM-Log-data/genome-properties-hydro.csv","../../data_files/HMM-Log-data/genome-properties-accessebility.csv"]
	temp_result = []
